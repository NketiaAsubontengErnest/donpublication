...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Return Book</h4>
                    ...
                    <form method="POST" class="forms-sample">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="" value="<?=esc($rows[0]->retquant)?>" class="form-control"
                                    id="exampleInputPassword1" placeholder="10" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputPassword1">Quantity Returning</label>
                                <input type="text" name="retquant" value="<?=esc($rows[0]->retquant)?>" class="form-control"
