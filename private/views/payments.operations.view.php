    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row m-2">
                        <h4 class="card-title">Payments Operations</h4>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php if ($rows): ?>
                                    <?php foreach ($rows as $row): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?= ucfirst(esc($row->customers->customername)) ?> (<?= esc($row->customers->custphone) ?>)
                                            </td>
                                            <td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="11" class="align-middle text-center text-sm">
                                            No Record Found
                                        </td>
                                    </tr>
                                <?php endif; ?>
