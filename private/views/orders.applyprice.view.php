                    ...
                    <form method="POST" class="forms-sample">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="" value="<?=$rows[0]->unitprice?>" class="form-control"
                                    id="exampleInputConfirmPassword1" placeholder="" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputConfirmPassword1">Unit Price</label>
                                <input type="text" name="unitprice" value="" class="form-control"
                                    id="exampleInputConfirmPassword1" placeholder="" required>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary mr-2">Apply</button>
                        <a class="btn btn-light float-end" href="<?=HOME?>/orders/listprice/<?=$rows[0]->ordernumber?>">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
