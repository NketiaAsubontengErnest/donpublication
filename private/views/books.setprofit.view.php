...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Add / Edit Profit</h4>
                    <?php if ($rows) : ?>
                        <form class="forms-sample" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputCity1">Profit</label>
                                    <input type="number" name="profit" class="form-control" id="exampleInputCity1" required placeholder="2000">
                                </div>
                            ...
                            <button type="submit" class="btn btn-primary mr-2">Set Profit</button>
                        </form>
                    <?php else : ?>
