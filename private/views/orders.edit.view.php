...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Book Quantity</h4>
                    ...
                    <form method="POST" class="forms-sample">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="exampleInputConfirmPassword1">New Quantity</label>
                                <input type="text" name="quantord" value="<?=$rows[0]->quantord?>" class="form-control"
